...
from api.serializers import EmployeeSerializer, FoodSerializer, RegisterEmployeeSerializer
...
class RgisterCustomerAPIView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid():
            if User.objects.exists(username=serializer.validated_data["username"]):  # type: ignore
                return Response(
